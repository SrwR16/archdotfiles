...
configFolderName = "com.dotfiles.hyprlandsettings" # config folder name
...
class Library:
    ...
    def runSetup(self):
        # Create hyprland-settings in .config folder
    ...
    def getKeywordValue(self,keyword,rowtype):
        ...
        if not "no such option" in keyword_json:
            ...
            # print(data) # DEBUG
            # print(keyword_type) # DEBUG
            # print(keyword_value) # DEBUG
