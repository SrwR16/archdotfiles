...
class HyprlandSettingsApplication(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='com.dotfiles.hyprlandsettings',
    ...
    def on_help(self, widget, _):
        Gtk.UriLauncher(uri="https://github.com/SrwR16/archdotfiles/wiki").launch()

    def on_check_updates(self, widget, _):
        Gtk.UriLauncher(uri="https://github.com/SrwR16/archdotfiles/tree/master?tab=readme-ov-file#update").launch()

    def on_report_issue(self, widget, _):
        Gtk.UriLauncher(uri="https://github.com/SrwR16/archdotfiles/issues").launch()
    ...
    def on_about_action(self, *args):
        about = Adw.AboutDialog(
            application_name="Dotfiles Hyprland Settings App",
            application_icon='com.dotfiles.hyprlandsettings',
            developer_name="Stephan Raabe",
            version="2.5.1",
            website="https://github.com/SrwR16/archdotfiles",
            issue_url="https://github.com/SrwR16/archdotfiles/issues",
            support_url="https://github.com/SrwR16/archdotfiles/issues",
