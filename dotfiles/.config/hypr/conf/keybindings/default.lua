...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/wallpaper-app"), { description = "Open wallpaper selector" })
...
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/reload-statusbar"), { description = "Reload Status Bar" })
hl.bind(mainMod .. " + CTRL + B", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/toggle-statusbar"), { description = "Toggle Status Bar" })
