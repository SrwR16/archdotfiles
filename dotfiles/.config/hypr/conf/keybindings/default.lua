...
-- Applications
hl.bind(mainMod .. " + RETURN", hl.dsp.exec_cmd("~/.config/dotfiles/settings/terminal.sh"), { description = "Open the terminal" })
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("~/.config/dotfiles/settings/browser.sh"), { description = "Open the browser" })
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("~/.config/dotfiles/settings/filemanager"), { description = "Open the filemanager" })
hl.bind(mainMod .. " + CTRL + E", hl.dsp.exec_cmd("~/.config/dotfiles/settings/emojipicker.sh"), { description = "Open the emoji picker" })
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("~/.config/dotfiles/settings/calculator.sh"), { description = "Open the calculator" })
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/toggle-allfloat"), { description = "Toggle floating for all windows of workspace" })
...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("quickshell ipc call main toggleMovie"), { description = "Open movie browser" })
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/wallpaper-app --random"), { description = "Change the wallpaper" })
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("quickshell ipc call main toggleWallpaper"), { description = "Open wallpaper selector" })
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/wallpaper-automation"), { description = "Start random wallpaper script" })
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/scripts/launcher.sh"), { description = "Open application launcher (rofi)" })
...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/cliphist"), { description = "Open clipboard manager" })
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/toggle-theme"), { description = "Toggle between light and dark mode" })
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/power -l"), { description = "Lock Screen" })
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/toggle-hyprsunset"), { description = "Toggle Hyprsunset" })
hl.bind(mainMod .. " + Tab", hl.dsp.exec_cmd("qs -p ~/.config/quickshell/overview.qml"), { description = "Open window selector (overview)" })
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/dotfiles/themes/themes.sh"), { description = "Open Select Window Menu" })

-- Example special workspace (scratchpad)
hl.bind(mainMod .. " + S",         hl.dsp.workspace.toggle_special("magic"), { description = "Toggle special workspace magic" })
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/toggle-scratchpad-window"), { description = "Toggle window in/out of special workspace magic" })
...
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl set 5%+ ; qs ipc call main refreshBrightness || true"), { locked = true, repeating = true, description = "Increase brightness" })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("brightnessctl set 5%- ; qs ipc call main refreshBrightness || true"), { locked = true, repeating = true, description = "Decrease brightness" })
...
hl.bind("XF86PowerOff",   hl.dsp.exec_cmd("~/.config/dotfiles/scripts/power -l"), { description = "Lock screen (power button)" })
