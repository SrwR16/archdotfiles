...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("qs -p ~/.config/quickshell/movie.qml"), { description = "Open movie browser" })
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/.config/dotfiles/scripts/wallpaper-app --random"), { description = "Change the wallpaper" })
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("qs -p ~/.config/quickshell/wallpaper-picker.qml"), { description = "Open wallpaper selector" })
