...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/dotfiles/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/dotfiles/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/dotfiles/listeners/another-listener.sh"
