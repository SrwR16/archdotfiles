...
FloatingWindow {
    id: root
    visible: false
    title: "Dotfiles Dotfiles Settings"
    implicitWidth: 900
    implicitHeight: 600
    ...
    property string scriptPath: Quickshell.env("HOME") + "/.local/bin/dotfiles-settings"
    property string settingsFile: Quickshell.env("HOME") + "/.config/dotfiles-settings/com.dotfiles.hyprland/settings.json"
    ...
    Process {
        command: ["bash", "-c", "cat " + root.settingsFile + " 2>&1"]
        running: true
